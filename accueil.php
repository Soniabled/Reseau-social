...
$req = "SELECT * FROM publication ORDER BY datep DESC";
...
<?php 
$code=$_SESSION['id_p'];
$req="SELECT id_p FROM likes where id_p=$code";
$resul=mysqli_query($conn,$req);
$likes=mysqli_num_rows($resul);  

?>
    <a href="actions.php?t=1&id=<?= $row['id_p'] ?>" class="card-link" id="likeBtn" onclick="toggleLike()"><i class="fa fa-gittip"></i> J'aime</a>(<?=$likes?>)
    <a href="commentaire.php?id=<?= $row['id_p'] ?>" class="card-link"><i class="fa fa-comment"></i> Commenter</a>
